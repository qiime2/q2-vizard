...
def scatterplot_2d(output_dir: str, metadata: Metadata,
                   ...
                   color_by: Union[CategoricalMetadataColumn,
                                   NumericMetadataColumn] = None,
                   title: str = None):
    ...
    # The color selector can use every metadata column plus an option to make
    # all points one color.
    md_cols_color = list(metadata.columns) + ['legendDefault']
